...
/*  You may notice that a variety of array variables logically local
    ...
    call on the export function in which whey are used.  */
...
export var NormLeap = new Array("Normal year", "Leap year");

/*  WEEKDAY_BEFORE  --  Return Julian date of given weekday (0 = Sunday)
                        in the seven days ending on jd.  */

export function weekday_before(weekday, jd)
{
...
export function search_weekday(weekday, jd, direction, offset)
{
...
export function next_weekday(weekday, jd)
{
...
export function previous_weekday(weekday, jd)
{
...
export function leap_gregorian(year)
{
    return ((year % 4) == 0) &&
...
export function n_weeks(weekday, jd, nthweek)
{
    var j = 7 * nthweek;
...
export function iso_to_julian(year, week, day)
{
...
export function iso_day_to_julian(year, day)
{
...
export function jd_to_iso_day(jd)
{
    var year, day;
...
export function pad(str, howlong, padwith) {
    var s = str.toString();
...
export function leap_julian(year)
{
...
export function hebrew_leap(year)
{
...
export function hebrew_year_months(year)
{
...
export function hebrew_delay_1(year)
{
...
export function hebrew_delay_2(year)
{
...
export function hebrew_year_days(year)
{
...
export function hebrew_month_days(year, month)
{
...
/*  JD_TO_HEBREW  --  Convert Julian date to Hebrew date
                      ...
                      the inverse export function, and is this very
                      slow.  */
...
export function equinoxe_a_paris(year)
{
...
export function paris_equinoxe_jd(year)
{
    var ep, epg;
...
export function annee_da_la_revolution(jd)
{
...
/*  JD_TO_FRENCH_REVOLUTIONARY  --  Calculate date in the French Revolutionary
                                    ...
                                    month in the results of this export function.  */
...
export function leap_islamic(year)
{
...
export function tehran_equinox(year)
{
...
export function tehran_equinox_jd(year)
{
    var ep, epg;
...
export function persiana_year(jd)
{
    var guess = jd_to_gregorian(jd)[0] - 2,
        lasteq, nexteq, adr;
...
export function jd_to_persiana(jd)
{
    var year, month, day,
        adr, equinox, yday;
...
export function persiana_to_jd(year, month, day)
{
...
export function leap_persiana(year)
{
...
export function leap_persian(year)
{
...
export function mayan_count_to_jd(baktun, katun, tun, uinal, kin)
{
...
export function jd_to_mayan_count(jd)
{
...
export function jd_to_mayan_haab(jd)
{
    var lcount, day;
...
export function jd_to_mayan_tzolkin(jd)
{
    var lcount;
...
export function presetDataToRequest(s)
{
    var eq = s.indexOf("=");
    var set = false;
    if (eq != -1) {
