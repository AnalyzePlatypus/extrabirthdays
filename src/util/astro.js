...
/*  MOD  --  Modulus export function which works for non-integers.  */
...
//  AMOD  --  Modulus export function which returns numerator if modulus is zero
...
export var Weekdays = new Array( "Sunday", "Monday", "Tuesday", "Wednesday",
...
/*  SUNPOS  --  Position of the Sun.  Please see the comments
                on the return statement at the end of this export function
